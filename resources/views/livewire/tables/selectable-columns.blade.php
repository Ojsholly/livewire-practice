<div>
    <div class="flex w-full pb-10">
        ...
        <div class="w-1/6 relative mx-1">
            <button wire:click="deleteUsers"
                class="block appearance-none w-full bg-red-500 border border-gray-200 text-white py-3 px-4 pr-8">Delete</button>
        </div>
    </div>
    @if ($users->isNotEmpty())
    <table class="w-full mb-6 table-auto">
        <thead>
            <tr>
                <th class="px-4 py-2"><input type="checkbox" wire:model="truncate" value=""> Delete All</th>
